...
use \Kaigan\QBank2\API\Model\PropertyCriteria;
use \Kaigan\QBank2\API\Model\Search;
use \Kaigan\QBank2\API\Model\SearchOrder;
use \Kaigan\QBank2\API\Model\SearchResult;
